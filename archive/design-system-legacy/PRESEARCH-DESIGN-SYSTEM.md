...
**Active Toggle:** Blue background (#2D8EFF), white knob on right
**Inactive Toggle:** Gray background (#6B7280), white knob on left
**Search Bar:** Rounded pill, dark gray (#2E2E2E), blue search icon
**Settings Panel:** Dark panel (#212224), white section headers, gray descriptions
